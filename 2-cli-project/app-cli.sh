...
# FILES
declare DIR_NAME="$( dirname "${BASH_SOURCE[0]}" )"
...
#$( dirname "${BASH_SOURCE[0]}" )/.react-cli.config
...
function setupVariablesFile {
    ...
    local sassJsVariables="${SASS_JS_VARIABLES}"
    local sassVariables="${SASS_VARIABLES}"
